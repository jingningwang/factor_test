...
if __name__ == "__main__":
    ...
    for n in range(0,20):
        df1_list = get_files_by_subfolder(folder_path_1,n)
        df2_list = get_files_by_subfolder(folder_path_2,n)
        df3_list = get_files_by_subfolder(folder_path_3,n)
        tasks = []
